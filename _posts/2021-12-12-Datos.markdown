...
1. Se nos entregaron 3 datasets con los logs (consultas) de los años 2019, 2020 y 2021, los cuáles unimos en un sólo dataframe agregando la columna "year" que contiene el año de la consulta, obteniendo la siguiente estructura:
...
2. También contábamos con una tabla con datos que caracterizan a los funcionarios de atención primaria, donde cada fila representa a un funcionario en un establecimiento. Luego de hacer la limpieza de esta tabla obtuvimos una estructura como la que se muestra a continuación:
...
3. Además de la tabla con datos de los funcionarios se nos entregó una tabla con datos que caracterizan a los establecimientos del sistema de salud, donde cada fila es un establecimiento. Luego de hacer limpieza y de seleccionar las columnas de interés obtuvimos la siguiente estructura:
...
4. Otra tabla que se nos entregó contiene datos que indican qué proveedor tecnológico (agente) está asociado a cada establecimiento.
